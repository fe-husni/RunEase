...
export function Toggle({ checked, onChange, label, className, disabled, ...props }: ToggleProps) {
  return (
    ...
    >
      <span
        className={cn(
          "pointer-events-none block h-5 w-5 rounded-full border-2 border-bauhaus-black shadow-none transition-transform",
